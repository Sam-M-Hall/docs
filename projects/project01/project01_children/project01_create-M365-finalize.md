...
![](/assets/images/projects/project01/create-M365-environment/M365-admin-user-setup-1.png "M365 - User Setup 1")

Click on the ***Users*** drop-down carrot to expand the options and select ***All users***.  
![](/assets/images/projects/project01/create-M365-environment/M365-admin-user-setup-2.png "M365 - User Setup 2")
...
![](/assets/images/projects/project01/create-M365-environment/M365-admin-user-setup-3.png "M365 - User Setup 3")

Once inside the ***User properties*** screen select the ***Edit properties*** button on the ribbon.  
![](/assets/images/projects/project01/create-M365-environment/M365-admin-user-setup-4.png "M365 - User Setup 4")
...
![](/assets/images/projects/project01/create-M365-environment/M365-admin-user-setup-5.png "M365 - User Setup 5")

Enter the details you'd like to configure for fields 1-3, then click the drop-down menu for the domain  
![](/assets/images/projects/project01/create-M365-environment/M365-admin-user-setup-6.png "M365 - User Setup 6")

and select your newly added domain from the previous section and click ![](/assets/images/projects/project01/create-M365-environment/M365-admin-user-setup-7-1.png "M365 - User Setup 7-1")   at the bottom.  
![](/assets/images/projects/project01/create-M365-environment/M365-admin-user-setup-7.png "M365 - User Setup 7")

You will be brought back to the ***User properties*** page for your account.  
![](/assets/images/projects/project01/create-M365-environment/M365-admin-user-setup-8.png "M365 - User Setup 8")

{: .important}
If the old info is still present, click the ![](/assets/images/projects/project01/create-M365-environment/M365-admin-user-setup-8-1.png "M365 - User Setup 8-1") button to update the screen.  
